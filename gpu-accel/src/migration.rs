...
use wgpu::{
    Adapter, AdapterInfo, BindGroupLayout, Buffer, BufferDescriptor, BufferUsages, CommandBuffer, CommandEncoder, CommandEncoderDescriptor, ComputePipeline, Device, DeviceType, Limits, Queue,
};
...
pub enum ConvShaderVariant {
    Standard { kernel_size: [u32; 2], stride: [u32; 2], use_shared_memory: bool },
    Pointwise,                           // Optimized 1x1 convolution
    Depthwise { kernel_size: [u32; 2] }, // Depthwise separable convolution
    Winograd3x3,                         // Winograd algorithm for 3x3
    Grouped { groups: u32 },             // Grouped convolution
}
